...
//#####################################################################################
//Fonction qui permet d'�couter les messages que le client lui envoi									 
//#####################################################################################
public class ServAuth 
{
	...
	public ServAuth(){
		...
		try 
		{
			// Creation du socket d'�coute du serveur Annuaire sur le port 13214
	...
	public void Service()
	{
		...
		while(true) 
		{
			...
			try 
			{
				// Quand on re�oit un message on lance un thread qui va les traiter
