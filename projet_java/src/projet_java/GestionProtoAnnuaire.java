...
public class GestionProtoAnnuaire 
{
	...
	public String analyserTraiter(String req) 
	{
		...
		else if(requete[0].equalsIgnoreCase("CONSULTINFOPERSO"))
		{
			...
			if (requete.length==2 )
			{
				// On r�cup�re le num�ro de la fiche de l'utilisateur
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSONOM"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re le nom de l'utilisateur pour le changer dans la fonction modificationInformationNom
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOPRENOM"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re le prenom de l'utilisateur pour le changer dans la fonction modificationInformationPrenom
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOTEL"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re le telephone de l'utilisateur pour le changer dans la fonction modificationInformationTel
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOFORMATION"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re la formation de l'utilisateur pour le changer dans la fonction modificationInformationFormation
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOANDIPLOME"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re l'annee d'obtention du diplome de l'utilisateur pour le changer dans la fonction modificationInformationAnneeDiplome
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOMAIL"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re le mail de l'utilisateur pour le changer dans la fonction modificationInformationMail
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOMDP"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re le mdp de l'utilisateur pour le changer dans la fonction modificationInformationMotDePasse
		...
		else if(requete[0].equalsIgnoreCase("MODIFINFOPERSOCOMPETENCE"))
		{
			...
			{
				String numFiche = requete[1];
				// On r�cup�re la comp�tence de l'utilisateur pour le changer dans la fonction modificationInformationCompetence
		...
		else if(requete[0].equalsIgnoreCase("RECHERCHENOM"))
		{
			if (requete.length==2)
			{
				// On recup�re le nom de l'utilisateur pour le rechercher dans la base de donnee
		...
		else if(requete[0].equalsIgnoreCase("RECHERCHEPRENOM"))
		{
			if (requete.length==2)
			{
				// On recup�re le prenom de l'utilisateur pour le rechercher dans la base de donnee
		...
		else if(requete[0].equalsIgnoreCase("RECHERCHEMAIL"))
		{
			if (requete.length==2) 
			{
				// On recup�re le mail de l'utilisateur pour le rechercher dans la base de donnee
		...
		else if(requete[0].equalsIgnoreCase("RECHERCHEFORMATION"))
		{
			if (requete.length==2) 
			{
				// On recup�re la formation de l'utilisateur pour le rechercher dans la base de donnee
		...
		else if(requete[0].equalsIgnoreCase("RECHERCHEANDIPLOME"))
		{
			if (requete.length==2) 
			{
				// On recup�re l'annee d'obtention du diplome de l'utilisateur pour le rechercher dans la base de donnee
		...
		else if(requete[0].equalsIgnoreCase("RECHERCHECOMPETENCE"))
		{
			if (requete.length==2)
			{
				// On recup�re la competence de l'utilisateur pour le rechercher dans la base de donnee
		...
		else if(requete[0].equalsIgnoreCase("VISIBILITENOM"))
		{
			if (requete.length==2)
			{
				// On recup�re le numero de fiche de l'utilisateur pour appeler la fonction qui s'occupe de la visibilite
				String NumFiche = requete[1];
		...
		else if(requete[0].equalsIgnoreCase("MODIFVISINOM"))
		{
			if (requete.length==2)
			{
				// On recup�re le numero de fiche de l'utilisateur pour appeler la fonction qui s'occupe modification de la visibilite
				String NumFiche = requete[1];
		...
		else if(requete[0].equalsIgnoreCase("SEELIKE"))
		{
			if (requete.length==2) 
			{
				// On recup�re le numero de fiche de l'utilisateur pour appeler la fonction qui s'occupe de voir les likes
				String NumFiche = requete[1];
		...
		else if(requete[0].equalsIgnoreCase("LIKE"))
		{
			if (requete.length==3)
			{
				// On recup�re le numero de fiche des utilisateurs
